...
private[spark] class ApplicationInfo(
    val startTime: Long,//TODO:开始时间
    val id: String,//TODO:id
    val desc: ApplicationDescription,//TODO:应用描述
    val submitDate: Date,//TODO:提交时间
    val driver: ActorRef,//TODO:driver的引用
    defaultCores: Int)//TODO:默认的核数
  extends Serializable {

  @transient var state: ApplicationState.Value = _
  @transient var executors: mutable.HashMap[Int, ExecutorDesc] = _ //todo:存放的事需要启动的executor，以eid为key
  @transient var removedExecutors: ArrayBuffer[ExecutorDesc] = _
  @transient var coresGranted: Int = _ //todo：需要分配的core的数量
